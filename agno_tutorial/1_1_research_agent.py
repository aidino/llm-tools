...
from textwrap import dedent # loại bỏ các khoảng trắng thụt đầu dòng chung từ một chuỗi nhiều dòng.

from agno.agent import Agent
from agno.models.openai import OpenAIChat

# Lớp này có thể cung cấp các công cụ liên quan đến dịch vụ Exa (có thể là tìm kiếm hoặc phân tích dữ liệu).
...
agent = Agent(
    ...
    #  Mô tả vai trò và phong cách viết của Agent (Giáo sư X-1000).
    description=dedent("""\
    ...
    """),
    # Hướng dẫn cách Agnet nên tiến hành nghiên cứu và viết báo cáo.
    instructions=dedent("""\
